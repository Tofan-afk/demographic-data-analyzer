...
def calculate_demographic_data(print_data=True):
    ...
    race_count = pd.Series(df['race'].value_counts(), index=None)
    ...
    highest_earning_country = (df[df['salary'] == '>50K']['native-country'].value_counts() *100 / df['native-country'].value_counts()).idxmax()
